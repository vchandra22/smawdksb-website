    ...
    <section>
        <section class="min-h-96 flex items-center justify-start w-auto relative mb-8">
            <div class="absolute bottom-0 top-0 left-0 right-0 z-10 overflow-hidden">
                <img src="{{ asset('assets/img/foto-siswa-sekolah.webp') }}" width="100" height="100" alt="foto siswa sma wd"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start justify-between w-full">
                    <div class="col-span-2 w-full px-4 py-0">
                        <div class="rounded-lg border-2 border-slate-400">
                            <img src="{{ asset('assets/img/foto-siswa-kebaya.webp') }}" class="object-cover w-full h-full rounded-md"
                    ...
                    <div class="text-start p-8 m-4 lg:m-0 w-full bg-slate-100 rounded-lg lg:sticky lg:top-16 lg:h-fit lg:z-10">
                        <h3

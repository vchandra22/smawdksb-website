    ...
    <section>
        <div class="min-h-screen">
            ...
            <div id="default-carousel" class="relative w-full z-10" data-carousel="slide">
                            ...
                            <div class="absolute w-full max-w-screen-2xl mx-auto left-0 right-0 bottom-0 top-1/4 my-auto">
                                <div class="h-full p-4 w-full md:w-1/2">
                                    <div class="flex-col items-center h-full text-start">
                                        <p class="text-xl xl:text-3xl text-slate-50 font-bold mb-4 min-h-4">Selamat Datang,
                                        </p>
                                        <h1
                                            class="text-4xl xl:text-7xl text-slate-50 font-bold mb-4 min-h-20 overflow-hidden line-clamp-2">
                                            SMA Wiyata Dharma Kesamben</h1>
                                        <p class="text-slate-50 italic text-xs md:text-sm xl:text-lg">
                                            “Bersama Menciptakan Generasi Cerdas dan Berkarakter. Kami Mendukung Setiap
                            ...
                            <div class="absolute w-full max-w-screen-2xl mx-auto left-0 right-0 bottom-0 top-1/4 my-auto">
                                <div class="h-full p-4 w-full md:w-1/2">
                                    <div class="flex-col items-center h-full text-start">
                                        ...
                                        <h1
                                            class="text-4xl xl:text-7xl text-slate-50 font-bold mb-4 min-h-20 overflow-hidden line-clamp-2">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam dolores magnam
                                            voluptas?</h1>
                                        <p class="text-slate-50 italic text-xs md:text-sm xl:text-lg">
                                            “Bersama Menciptakan Generasi Cerdas dan Berkarakter. Kami Mendukung Setiap
                                            Langkah Menuju Masa Depan Gemilang.”
                            ...
                            <div class="absolute w-full max-w-screen-2xl mx-auto left-0 right-0 bottom-0 top-1/4 my-auto">
                                <div class="h-full p-4 w-full md:w-1/2">
                                    <div class="flex-col items-center h-full text-start">
                                        ...
                                        <h1
                                            class="text-4xl xl:text-7xl text-slate-50 font-bold mb-4 min-h-20 overflow-hidden line-clamp-2">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero!</h1>
                                        <p class="text-slate-50 italic text-xs md:text-sm xl:text-lg">
                                            “Bersama Menciptakan Generasi Cerdas dan Berkarakter. Kami Mendukung Setiap
                                            Langkah Menuju Masa Depan Gemilang.”
                                        </p>
                ...
                <!-- Slider controls -->
                <div
                    class="absolute bottom-1.5 top-2/3 mt-6 gap-4 start-0 md:-left-5 xl:ms-48 z-30 flex items-center justify-center h-20 px-4 focus:outline-none">

<nav class="bg-slate-50 border-gray-200 md:border-b">
    <div class="w-full flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{ asset('assets/img/logo-smawd-teks.png') }}" class="h-8 md:h-10 xl:h-12"
                alt="Logo SMA Wiyata Dharma Kesamben" />
        </a>
                ...
                <li>
                    ...
                    <div id="dropdownNavbar-4"
                        ...
                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100">Staf Tenaga
                                    Kependidikan</a>
                            </li>
                        </ul>
                    </div>

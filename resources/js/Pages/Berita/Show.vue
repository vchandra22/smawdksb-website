<template>
    <section class="min-h-96 flex items-center justify-start w-auto relative">
        <div class="absolute bottom-0 top-0 left-0 right-0 z-10 overflow-hidden">
            <img :src="fotoSiswa" width="100" height="100" alt="foto siswa sma wd"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start justify-between w-full">
                <div class="col-span-2 w-full px-4 py-0">
                    ...
                    <div class="rounded-lg border-2 border-slate-400">
                        <img :src="fotoSiswa" class="object-cover w-full h-full rounded-md" width="100" height="100"
                            alt="gambar detail berita">
                    </div>
                    <article class="prose prose-sm md:prose-lg lg:col-span-2 m-4 lg:m-0 pt-4 max-w-none lg:pb-20">
                        ...
                        maecenas pharetra convallis posuere morbi leo. Et malesuada fames ac turpis egestas sed. Purus
                        non
                        ...
                        faucibus turpis. Orci sagittis eu volutpat odio facilisis mauris sit amet massa. A arcu cursus
                        vitae
                        congue mauris. Est velit egestas dui id ornare arcu odio ut. Et tortor at risus viverra
                        adipiscing
                        at in.
                        Donec massa sapien faucibus et molestie ac feugiat sed. Platea dictumst quisque sagittis purus.
                        Turpis massa tincidunt dui ut ornare lectus sit. Sagittis nisl rhoncus mattis rhoncus urna
                        neque.
                        Feugiat in ante metus dictum at. Ullamcorper morbi tincidunt ornare massa eget egestas purus
                        viverra
                        ...
                        diam ut. Est ullamcorper eget nulla facilisi. Auctor eu augue ut lectus arcu bibendum at varius
                        vel.
                        ...
                        montes nascetur ridiculus. Ac orci phasellus egestas tellus rutrum. Dolor purus non enim
                        praesent
                        elementum facilisis leo vel fringilla. Vitae congue mauris rhoncus aenean vel elit. Vel quam
                        elementum pulvinar etiam non. Ut sem viverra aliquet eget sit amet tellus cras. Sed risus
                        ultricies
                        tristique nulla. Varius sit amet mattis vulputate. Curabitur vitae nunc sed velit dignissim
                        sodales
                        ut eu.
                    </article>
                </div>
                <div
                    class="text-start p-8 m-4 lg:m-0 bg-slate-100 w-full rounded-lg lg:sticky lg:top-16 lg:h-fit lg:z-10">
                    <h3

<template>
        ...
        <div class="splide__track overflow-hidden">
            <ul class="splide__list">
                ...
                <li class="splide__slide">
                    <img :src="carouselImage" class="w-full object-cover h-full" alt="...">
                        ...
                        <div class="h-full p-4 w-full md:w-1/2">
                            <div class="flex-col items-center h-full text-start">
                                ...
                                <p class="text-slate-50 italic text-xs md:text-sm xl:text-lg">
                                    “Bersama Menciptakan Generasi Cerdas dan Berkarakter. Kami Mendukung Setiap Langkah
    ...
    <div class="max-w-screen-2xl mx-auto py-20 px-4">
        <div class="grid grid-cols-1 justify-center md:grid-cols-5 gap-4 p-4 md:p-8 bg-slate-100 rounded-md shadow-sm">
            <div class="w-full">
                <div class="h-full flex items-center border border-slate-400 rounded-md">
                    <img class="object-cover h-full overflow-hidden w-full rounded-sm" :src="carouselImage" alt="#">
                </div>
            </div>
        ...
        <div class="max-w-screen-2xl mx-auto">
            <div class="flex items-center justify-between gap-4">
                ...
                <a href="#"
                    ...
                    <svg class="w-3.5 h-3.5 md:ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 14 10">
